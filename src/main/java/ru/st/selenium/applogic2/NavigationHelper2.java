...
public class NavigationHelper2 extends DriverBasedHelper implements NavigationHelper {
	...
	public void gotoAddFilmPage() {
		pages.homePage.ensurePageLoaded().clickAddFilmButton();

	}

	@Override
	public void gotoHomePage() {
		pages.internalPage.ensurePageLoaded().clickHomePage();
		
	}

	@Override
	public void gotoAboutFilmPage(int filmId) {
		pages.homePage.ensurePageLoaded().clickAboutFilm(filmId);
